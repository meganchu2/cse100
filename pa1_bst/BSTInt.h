...
* PA1 CSE 100 2017
*
* Header file for a BSTInt class that holds ints
*/
 ...
 * Author: Megan Chu
 *
 * tells us which public and private functions to look for in BSTInt class
 *
 */
class BSTInt {
...
private:
   ...
   */
  int heightHelper(BSTNodeInt* curr) const;
